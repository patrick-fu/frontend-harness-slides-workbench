...
const WOODBLOCK_SOURCES = [
  {
    authority: "British Museum",
    title: "Under the Wave off Kanagawa (Kanagawa-oki nami-ura)",
    citation:
      "British Museum collection object 1937,0710,0.147, Katsushika Hokusai, Under the Wave off Kanagawa.",
    url: "https://www.britishmuseum.org/collection/object/A_1937-0710-0-147",
    supports:
      "Supports the attribution to Katsushika Hokusai, the Under the Wave off Kanagawa title, its Thirty-six Views of Mt Fuji series, the 1831 production date, color woodblock technique, and a 25.9-centimetre print height.",
  },
  {
    authority: "The Metropolitan Museum of Art",
    title: "Art of the Pleasure Quarters and the Ukiyo-e Style",
    citation:
      "The Metropolitan Museum of Art, Timeline of Art History, Art of the Pleasure Quarters and the Ukiyo-e Style.",
    url: "https://www.metmuseum.org/pt/essays/art-of-the-pleasure-quarters-and-the-ukiyo-e-style",
    supports:
      "Supports the ukiyo-e context and the dates shown for Katsushika Hokusai (1760–1849) and Utagawa Hiroshige (1797–1858), including their early-nineteenth-century landscape printmaking.",
  },
  {
    authority: "British Museum",
    title: "Utamaro, Ten Classes of Women's Physiognomy",
    citation:
      "British Museum collection object 1906,1220,0.329, Kitagawa Utamaro, Ten Classes of Women's Physiognomy.",
    url: "https://www.britishmuseum.org/collection/object/A_1906-1220-0-329",
    supports:
      "Supports the Kitagawa Utamaro attribution and Ten Classes of Women's Physiognomy series named in the final artist list.",
  },
  {
    authority: "The Metropolitan Museum of Art",
    title: "Utamaro: Songs of the Garden",
    citation:
      "The Metropolitan Museum of Art, Utamaro: Songs of the Garden.",
    url: "https://resources.metmuseum.org/resources/metpublications/pdf/Utamaro_Songs_of_the_Garden.pdf",
    supports:
      "Supports the historical lifespan shown for Kitagawa Utamaro (1753–1806) in the final artist list.",
  },
...
const WOODBLOCK_TRANSITION_SCORE = {
  "1->2": "wipe",
  "2->3": "wipe",
  "3->4": "wipe",
  "4->5": "wipe",
  ...
  const renderNav = () => {
    ...
    return (
      <div
        ...
        data-navigation-carrier="woodblock-wave-chapter-seals"
...
export default defineTopic({
  ...
  transitionScore: WOODBLOCK_TRANSITION_SCORE,
  evidence: {
    kind: "mixed",
    sources: WOODBLOCK_SOURCES,
    boundary: {
