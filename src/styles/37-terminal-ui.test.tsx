...
import TerminalUI37, { getMetadata } from "./37-terminal-ui";
...
describe("Style 37: 37-terminal-ui — render coverage", () => {
...
describe("Style 37: 37-terminal-ui — thumbnail mode", () => {
...
describe("Style 37: 37-terminal-ui — navigation presence", () => {
...
describe("Style 37: 37-terminal-ui — navigation behavior", () => {
...
describe("Style 37: 37-terminal-ui — overflow check", () => {
...
describe("Style 37: 37-terminal-ui — metadata structure", () => {
  it("returns complete metadata", () => {
    const meta = getMetadata("en");
    expect(meta.id).toBe("operating-manual");
