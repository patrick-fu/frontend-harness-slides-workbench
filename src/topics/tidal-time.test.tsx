...
import componentSource from "./tidal-time.tsx?raw";
import styleSource from "./tidal-time.module.css?inline";
...
describe("Tidal Time topic protocol", () => {
  it("exports the locked topic, facts packet, navigation profile, and score", () => {
    expect(definition.id).toBe("tidal-time");
    ...
    expect(definition.transitionScore).toBe(TIDAL_TIME_TRANSITION_SCORE);
