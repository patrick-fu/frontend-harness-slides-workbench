...
runTopicContract(pairingBoard);

const TopicStage = pairingBoard.Stage;
...
describe("Pairing Board — render coverage", () => {
...
describe("Pairing Board — thumbnail mode", () => {
...
describe("Pairing Board — navigation presence", () => {
...
describe("Pairing Board — navigation behavior", () => {
...
describe("Pairing Board — overflow check", () => {
...
describe("Pairing Board — metadata structure", () => {
  it("keeps complete metadata", () => {
    const meta = pairingBoard.metadata.en;
    expect(pairingBoard.styleId).toBe("collaborative-pairing-board");
    expect(pairingBoard.title).toEqual({ en: "Pairing Board", zh: "配对板" });
