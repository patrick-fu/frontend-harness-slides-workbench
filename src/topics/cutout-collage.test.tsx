...
import cutoutCollage from "./cutout-collage";

const { Stage } = cutoutCollage;

runTopicContract(cutoutCollage);
...
describe("Cutout Collage — render coverage", () => {
...
describe("Cutout Collage — thumbnail mode", () => {
...
describe("Cutout Collage — navigation presence", () => {
...
describe("Cutout Collage — navigation behavior", () => {
...
describe("Cutout Collage — overflow check", () => {
...
describe("Cutout Collage — metadata structure", () => {
  it("returns complete metadata", () => {
    const meta = cutoutCollage.metadata.en;
    expect(cutoutCollage.styleId).toBe("analog-cutout-collage");
    expect(cutoutCollage.title).toEqual({ en: "Cutout Collage", zh: "剪纸拼贴" });
