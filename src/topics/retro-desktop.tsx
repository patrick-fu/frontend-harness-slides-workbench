...
import styles from "./retro-desktop.module.css";
...
function TopicStage({
  ...
  const renderNavIndicators = () => {
    ...
    return (
      <div
        ...
        data-navigation-carrier="retro-desktop-scene-indicators"
  ...
  return (
    <div className={rootClasses} data-topic-id="retro-desktop">
            <SpatialSceneTrack
        scene={scene}
        beat={beat}
...
export default defineTopic({
  ...
  title: { en: "Retro Desktop", zh: "复古桌面" },
