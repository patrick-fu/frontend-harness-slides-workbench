...
function useFonts() {
  useEffect(() => {
    ...
    const id = "style-19-useful-week-v2-fonts";
...
export function getMetadata(lang: Lang): StyleMetadata {
  return {
    ...
    name: lang === "zh" ? "暖调长篇特写" : "Warm Editorial Feature",
...
export default function UsefulWeekNotesV2({
  scene,
  beat,
  language,
  isThumbnail,
...
export const usefulWeekNotesTopic = defineStyleTopic({
  id: "useful-week",
  topic: {
    en: "Useful Week",
    zh: "有用一周",
