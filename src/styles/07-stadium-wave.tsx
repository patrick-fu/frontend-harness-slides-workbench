...
import styles from "./07-stadium-wave.module.css";
...
function StadiumNav({
  ...
  return (
    <nav
      ...
      data-navigation-carrier="stadium-seating-array"
...
export function getMetadata(language: Language): StyleMetadata {
  return {
    ...
    name: language === "zh" ? "手绘表情白板" : "Sketch Board Emoji",
...
export default function StadiumWave({
  scene,
  beat,
  language,
  isThumbnail,
...
export const stadiumWaveTopic = defineStyleTopic({
  id: "stadium-wave",
  topic: {
    en: "Stadium Wave",
    zh: "看台人浪",
