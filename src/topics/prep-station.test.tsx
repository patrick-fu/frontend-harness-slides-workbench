...
import prepStation from "./prep-station";
import type { TopicStageProps } from "../domain/topic";
import { runTopicContract } from "../testing/topic-contract";

runTopicContract(prepStation);

const TopicStage = prepStation.Stage;
...
describe("Prep Station — render coverage", () => {
...
describe("Prep Station — thumbnail mode", () => {
...
describe("Prep Station — navigation presence", () => {
...
describe("Prep Station — navigation behavior", () => {
...
describe("Prep Station — overflow check", () => {
...
describe("Prep Station — metadata structure", () => {
  it("keeps complete metadata", () => {
    const meta = prepStation.metadata.en;
    expect(prepStation.styleId).toBe("kitchen-prep-station");
    expect(prepStation.title).toEqual({ en: "Prep Station", zh: "备料台" });
