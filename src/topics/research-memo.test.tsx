...
import topic from "./research-memo";
...
describe("Research Memo — render coverage", () => {
...
describe("Research Memo — thumbnail mode", () => {
...
describe("Research Memo — navigation presence", () => {
...
describe("Research Memo — navigation behavior", () => {
...
describe("Research Memo — overflow check", () => {
...
describe("Research Memo — metadata structure", () => {
  it("returns complete metadata", () => {
    const meta = topic.metadata.en;
    expect(topic.id).toBe("research-memo");
    expect(topic.styleId).toBe("research-memo");
    expect(topic.title.en.length).toBeGreaterThan(0);
