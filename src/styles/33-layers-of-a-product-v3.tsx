...
import styles from "./33-layers-of-a-product-v3.module.css";
...
export default function LayersOfAProductV3({
  scene,
  beat,
  language,
  isThumbnail,
...
export const LayersOfAProductV3Version = defineStyleVersion({
  id: "v3",
