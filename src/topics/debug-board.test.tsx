...
import definition from "./debug-board";
...
describe("Debug Board — render coverage", () => {
...
describe("Debug Board — thumbnail mode", () => {
...
describe("Debug Board — navigation presence", () => {
...
describe("Debug Board — navigation behavior", () => {
...
describe("Debug Board — overflow check", () => {
...
describe("Debug Board — metadata structure", () => {
  it("retains complete metadata", () => {
    const meta = definition.metadata.en;
    expect(definition.id).toBe("debug-board");
    expect(definition.styleId).toBe("debug-reaction-board");
