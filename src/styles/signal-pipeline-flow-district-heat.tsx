...
import type { BespokeStyleProps, StyleMetadata, TopicSource, TopicTransitionScore } from "../types";
import SpatialSceneTrack from "./SpatialSceneTrack";
import type { BeatLayoutMode, SceneTransitionMap } from "./SpatialSceneTrack";
import { defineStyleTopic } from "./topic";
import styles from "./signal-pipeline-flow-district-heat.module.css";
...
export const districtHeatTopic = defineStyleTopic({
  id: "district-heat",
  topic: {
    en: "Second Heat",
    zh: "城市余热",
