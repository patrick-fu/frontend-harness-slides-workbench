...
import componentSource from "./saharan-dust.tsx?raw";
import cssSource from "./saharan-dust.module.css?inline";
...
describe("saharan-dust topic contract", () => {
  it("exports the TopicDefinition, exact score, and prescribed navigation", () => {
    expect(topic.id).toBe("saharan-dust");
  ...
  it("keeps EN/ZH metadata aligned to the 1-3-2-4-1 intensity curve", () => {
    ...
    expect(topic.styleId).toBe("expedition-screenprint");
...
describe("saharan-dust evidence-aware visual narrative", () => {
...
describe("saharan-dust transitions and dust-arc navigation", () => {
...
describe("saharan-dust motion and stage safety", () => {
