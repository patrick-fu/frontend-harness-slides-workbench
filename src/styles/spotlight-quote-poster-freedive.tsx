...
import styles from "./spotlight-quote-poster-freedive.module.css";
...
export function getMetadata(language: Language): StyleMetadata {
  return {
    ...
    name: language === "zh" ? "聚光引言海报" : "Spotlight Quote Poster",
...
export const freediveTopic = defineStyleTopic({
  id: "freedive",
  topic: {
    en: "Freedive",
    zh: "自由潜水",
