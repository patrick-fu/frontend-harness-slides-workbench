...
import styles from "./29-greatest-hits-vol1-v3.module.css";
...
/* ── font stacks (declared in getMetadata().fonts) ── */
...
export function getMetadata(lang: Lang): StyleMetadata {
  ...
  return {
    id: "29",
    band: "craft-cultural",
    name: en ? "Cassette-Era Packaging" : "卡带时代包装",
...
export const greatestHitsVol1V3Version = defineStyleVersion({
  id: "v3",
...
export default GreatestHitsVol1V3;
