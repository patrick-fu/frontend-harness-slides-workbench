...
import FinancialTimes19, { getMetadata } from "./19-financial-times";
...
describe("Style 19: financial-times — render coverage", () => {
...
describe("Style 19: financial-times — thumbnail mode", () => {
...
describe("Style 19: financial-times — navigation presence", () => {
...
describe("Style 19: financial-times — navigation behavior", () => {
...
describe("Style 19: financial-times — overflow check", () => {
...
describe("Style 19: financial-times — metadata structure", () => {
  it("returns complete metadata", () => {
    const meta = getMetadata("en");
    expect(meta.id).toBe("warm-editorial-feature");
