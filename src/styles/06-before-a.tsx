...
import styles from "./06-before-a.module.css";
...
export const BEFORE_A_TRANSITION_SCORE = {
  "1->2": "afterimage",
  "2->3": "zoom-through",
  "3->4": "multi-blind",
  "4->5": "afterimage",
...
export const BEFORE_A_TRANSITION_MAP: SceneTransitionMap =
  BEFORE_A_TRANSITION_SCORE;

export const BEFORE_A_TRANSITION_MODIFIER_MAP: SceneTransitionModifierMap = {
  "3->4": "letterform-lineage",
};

export const BEFORE_A_SOURCES = [
  {
...
function useFonts() {
  useEffect(() => {
    const id = "style-06-before-a-fonts";
...
export function getMetadata(lang: Lang): StyleMetadata {
  return {
    ...
    name: lang === "zh" ? "动势字拳" : "Kinetic Type Punchline",
...
export default function BeforeA({
  scene,
  beat,
  language,
  isThumbnail,
...
export const beforeATopic = defineStyleTopic({
  id: "before-a",
  topic: {
    en: "Before A",
    zh: "A之前",
