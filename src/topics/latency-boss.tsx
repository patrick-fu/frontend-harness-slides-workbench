...
import styles from "./latency-boss.module.css";
...
function LifePipNav({
  ...
  return (
    <nav
      className={styles.lifeNav}
      aria-label={language === "zh" ? "关卡导航" : "Level navigation"}
      data-topic-navigation="true"
      data-navigation-geometry="edge-scale"
      data-navigation-carrier="life-pip-level-navigation"
