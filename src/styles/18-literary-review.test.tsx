...
import LiteraryReview18, { getMetadata } from "./18-literary-review";
...
describe("Style 18: literary-review — render coverage", () => {
...
describe("Style 18: literary-review — thumbnail mode", () => {
...
describe("Style 18: literary-review — navigation presence", () => {
...
describe("Style 18: literary-review — navigation behavior", () => {
...
describe("Style 18: literary-review — overflow check", () => {
...
describe("Style 18: literary-review — metadata structure", () => {
  it("returns complete metadata", () => {
    const meta = getMetadata("en");
    expect(meta.id).toBe("magazine-masthead");
