...
describe("deco-gala render coverage", () => {
...
describe("deco-gala thumbnail mode", () => {
...
describe("deco-gala navigation presence", () => {
...
describe("deco-gala navigation behavior", () => {
...
describe("deco-gala overflow check", () => {
...
describe("deco-gala metadata structure", () => {
