...
describe("Source Diff — render coverage", () => {
...
describe("Source Diff — thumbnail mode", () => {
...
describe("Source Diff — navigation presence", () => {
...
describe("Source Diff — navigation behavior", () => {
...
describe("Source Diff — overflow check", () => {
...
describe("Source Diff — metadata structure", () => {
  it("returns complete metadata", () => {
    const meta = topic.metadata.en;
    expect(topic.id).toBe("source-diff");
    expect(topic.styleId).toBe("annotated-source-diff");
    expect(topic.title).toEqual({ en: "Source Diff", zh: "源码差异" });
