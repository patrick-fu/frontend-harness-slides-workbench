...
import LegalBrief, { getMetadata } from "./42-legal-brief";
...
describe("Style 42: Legal Brief — render coverage", () => {
...
describe("Style 42: Legal Brief — thumbnail mode", () => {
...
describe("Style 42: Legal Brief — navigation presence", () => {
...
describe("Style 42: Legal Brief — navigation behavior", () => {
...
describe("Style 42: Legal Brief — overflow check", () => {
...
describe("Style 42: Legal Brief — metadata structure", () => {
  it("returns complete metadata", () => {
    const meta = getMetadata("en");
    expect(meta.id).toBe("decision-record");
