...
import ManuscriptScroll24, { getMetadata } from "./24-manuscript-scroll";
...
function renderStage(props: Partial<BespokeStyleProps> = {}) {
  ...
  const { container, ...rest } = render(
    <div style={{ width: 1920, height: 1080, containerType: "size",
      ...
      <ManuscriptScroll24 {...defaultProps} />
    </div>,
  );
...
describe("Style 24: manuscript-scroll — render coverage", () => {
...
describe("Style 24: manuscript-scroll — thumbnail mode", () => {
...
describe("Style 24: manuscript-scroll — navigation presence", () => {
...
describe("Style 24: manuscript-scroll — navigation behavior", () => {
...
describe("Style 24: manuscript-scroll — overflow check", () => {
...
describe("Style 24: manuscript-scroll — metadata structure", () => {
  it("returns complete metadata", () => {
    const meta = getMetadata("en");
    expect(meta.id).toBe("analog-cutout-collage");
