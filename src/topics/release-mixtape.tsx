...
import styles from "./release-mixtape.module.css";
...
function useFonts() {
  useEffect(() => {
    const id = "release-mixtape-fonts";
...
function CassetteCounterNav({
  ...
  return (
    <nav
      ...
      aria-label="cassette window counter"
      data-topic-navigation="true"
      data-navigation-geometry="object-controller"
      data-navigation-carrier="release-mixtape-counter"
