...
import definition from "./editorial-feature";
...
describe("Editorial Feature — render coverage", () => {
...
describe("Editorial Feature — thumbnail mode", () => {
...
describe("Editorial Feature — navigation presence", () => {
...
describe("Editorial Feature — navigation behavior", () => {
...
describe("Editorial Feature — overflow check", () => {
...
describe("Editorial Feature — metadata structure", () => {
  it("returns complete metadata", () => {
    const meta = getMetadata("en");
    expect(definition.id).toBe("editorial-feature");
