...
import AuditReport, { getMetadata } from "./46-audit-report";
...
describe("Style 46: Audit Report — render coverage", () => {
...
describe("Style 46: Audit Report — thumbnail mode", () => {
...
describe("Style 46: Audit Report — navigation presence", () => {
...
describe("Style 46: Audit Report — navigation behavior", () => {
...
describe("Style 46: Audit Report — overflow check", () => {
...
describe("Style 46: Audit Report — metadata structure", () => {
  it("returns complete metadata", () => {
    const meta = getMetadata("en");
    expect(meta.id).toBe("checklist-ledger");
