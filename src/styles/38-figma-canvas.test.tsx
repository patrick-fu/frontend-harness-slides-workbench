...
import FigmaCanvas38, { getMetadata } from "./38-figma-canvas";
...
describe("Style 38: 38-figma-canvas — render coverage", () => {
...
describe("Style 38: 38-figma-canvas — thumbnail mode", () => {
...
describe("Style 38: 38-figma-canvas — navigation presence", () => {
...
describe("Style 38: 38-figma-canvas — navigation behavior", () => {
...
describe("Style 38: 38-figma-canvas — overflow check", () => {
...
describe("Style 38: 38-figma-canvas — metadata structure", () => {
  it("returns complete metadata", () => {
    const meta = getMetadata("en");
    expect(meta.id).toBe("widescreen-title-card");
