...
import ParticleField, { getMetadata } from "./40-particle-field";
...
describe("Style 40: Particle Field — render coverage", () => {
...
describe("Style 40: Particle Field — thumbnail mode", () => {
...
describe("Style 40: Particle Field — navigation presence", () => {
...
describe("Style 40: Particle Field — navigation behavior", () => {
...
describe("Style 40: Particle Field — overflow check", () => {
...
describe("Style 40: Particle Field — metadata structure", () => {
  it("returns complete metadata", () => {
    const meta = getMetadata("en");
    expect(meta.id).toBe("arcade-boss-fight");
