...
import styles from "./06-one-constraint-wins.module.css";
...
function useFonts() {
  useEffect(() => {
    const id = "style-06-one-constraint-wins-v2-fonts";
...
export default function OneConstraintWinsV2({
  scene,
  beat,
  language,
  isThumbnail,
...
export const oneConstraintWinsTopic = defineStyleTopic({
  id: "one-constraint",
  topic: {
    en: "One Constraint",
    zh: "一个约束",
