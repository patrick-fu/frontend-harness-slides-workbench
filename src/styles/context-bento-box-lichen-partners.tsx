...
import styles from "./context-bento-box-lichen-partners.module.css";
...
interface LichenSource extends TopicSource {
  id: SourceId;
...
export function getMetadata(language: Language): StyleMetadata {
  return {
    ...
    band: "text-report",
    name: language === "zh" ? "上下文食盒" : "Context Bento Box",
...
export default function LichenPartners({
  scene,
  beat,
  language,
  isThumbnail,
  ...
  return (
    <div
      ...
      data-style-id="context-bento-box"
