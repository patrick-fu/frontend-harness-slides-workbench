...
import definition from "./pipeline";
...
describe("Pipeline — render coverage", () => {
...
describe("Pipeline — thumbnail mode", () => {
...
describe("Pipeline — navigation presence", () => {
...
describe("Pipeline — navigation behavior", () => {
...
describe("Pipeline — overflow check", () => {
