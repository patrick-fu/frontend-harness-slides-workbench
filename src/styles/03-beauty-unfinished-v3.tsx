...
import styles from "./03-beauty-unfinished-v3.module.css";
...
function BeautyUnfinishedV3(props: BespokeStyleProps) {
  ...
  return (
    ...
    >
      ...
      />
      {/* N8 · no visible navigation — envelope owns keyboard / click-zone nav */}
    </div>
  );
}
...
export function getMetadata(lang: "en" | "zh"): StyleMetadata {
  ...
  return {
    ...
    name: en ? "Wabi-Sabi Ceramic" : "侘寂陶器",
...
export const beautyUnfinishedV3Version = defineStyleVersion({
  id: "v3",
...
export default BeautyUnfinishedV3;
