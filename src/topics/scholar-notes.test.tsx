...
import definition from "./scholar-notes";
...
describe("Scholar Notes — render coverage", () => {
...
describe("Scholar Notes — thumbnail mode", () => {
...
describe("Scholar Notes — navigation presence", () => {
...
describe("Scholar Notes — navigation behavior", () => {
...
describe("Scholar Notes — overflow check", () => {
...
describe("Scholar Notes — metadata structure", () => {
  it("returns complete metadata", () => {
    const meta = getMetadata("en");
    expect(definition.id).toBe("scholar-notes");
