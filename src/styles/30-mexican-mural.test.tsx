...
import MexicanMural30, { getMetadata } from "./30-mexican-mural";
...
describe("Style 30: 30-mexican-mural — thumbnail mode", () => {
...
describe("Style 30: 30-mexican-mural — navigation presence", () => {
...
describe("Style 30: 30-mexican-mural — navigation behavior", () => {
...
describe("Style 30: 30-mexican-mural — overflow check", () => {
...
describe("Style 30: 30-mexican-mural — metadata structure", () => {
  it("returns complete metadata", () => {
    const meta = getMetadata("en");
    expect(meta.id).toBe("neo-brutalist-bulletin");
