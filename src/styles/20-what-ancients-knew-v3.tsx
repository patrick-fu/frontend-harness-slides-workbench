...
import styles from "./20-what-ancients-knew-v3.module.css";
...
export function getMetadata(lang: Lang): StyleMetadata {
  ...
  return {
    ...
    name: en ? "Scholar's Vellum" : "学者羊皮卷",
...
export const whatAncientsKnewV3Version = defineStyleVersion({
  id: "v3",
...
export default ScholarsVellumV3;
