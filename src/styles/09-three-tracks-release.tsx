...
import styles from "./09-three-tracks-release.module.css";
...
function getMetadata(lang: Lang): StyleMetadata {
  return {
    ...
    name: lang === "zh" ? "意图地铁图" : "Subway Map of Intent",
...
export default function ThreeTracksReleaseV2({
  scene,
  beat,
  language,
  isThumbnail,
...
export const threeTracksReleaseTopic = defineStyleTopic({
  id: "release-tracks",
  topic: {
    en: "Release Tracks",
    zh: "发布轨道",
