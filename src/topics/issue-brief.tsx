...
import styles from "./issue-brief.module.css";
...
function TopicStage({
  ...
  useEffect(() => {
    ...
    inject(
      "issue-brief-fonts-inter",
      "https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&display=swap",
    );
    inject(
      "issue-brief-fonts-noto-serif-sc",
  ...
  return (
    <div data-testid="issue-brief-root" className={rootClasses}>
            <SpatialSceneTrack
        scene={scene}
        beat={beat}
        transitionKind="wipe"
