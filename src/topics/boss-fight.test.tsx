...
describe("Boss Fight — render coverage", () => {
...
describe("Boss Fight — thumbnail mode", () => {
...
describe("Boss Fight — navigation presence", () => {
...
describe("Boss Fight — navigation behavior", () => {
...
describe("Boss Fight — overflow check", () => {
...
describe("Boss Fight — metadata structure", () => {
  it("returns complete metadata", () => {
    const meta = topic.metadata.en;
    expect(topic.id).toBe("boss-fight");
