...
import componentSource from "./reinforced-concrete.tsx?raw";
import cssSource from "./reinforced-concrete.module.css?inline";
...
describe("reinforced-concrete protocol and sources", () => {
  it("exports the planned topic, navigation profile, claims packet, and exact score", () => {
    expect(topic.id).toBe("reinforced-concrete");
  ...
  it("keeps both languages aligned to the 4-1-2-2-1 beat curve, ending scene 5 at beat 0", () => {
    for (const language of ["en", "zh"] as const) {
      ...
      expect(topic.styleId).toBe("machine-age-deco");
...
describe("reinforced-concrete material narrative", () => {
...
describe("reinforced-concrete load ruler interaction", () => {
...
describe("reinforced-concrete deterministic states and stage discipline", () => {
