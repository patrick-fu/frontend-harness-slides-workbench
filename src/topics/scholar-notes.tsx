...
import styles from "./scholar-notes.module.css";
  ...
  const renderNavIndicators = () => {
    ...
    return (
      <div
        ...
        data-navigation-carrier="scholar-notes-perimeter-dots"
...
export default defineTopic({
  ...
  title: { en: "Scholar Notes", zh: "学者笔记" },
