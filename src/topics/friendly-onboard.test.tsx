...
import definition from "./friendly-onboard";
...
describe("Friendly Onboard — render coverage", () => {
...
describe("Friendly Onboard — thumbnail mode", () => {
...
describe("Friendly Onboard — navigation presence", () => {
...
describe("Friendly Onboard — navigation behavior", () => {
...
describe("Friendly Onboard — overflow check", () => {
