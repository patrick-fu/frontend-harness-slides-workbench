...
import styles from "./42-choose-boundary.module.css";
...
function AdrSidebar({
  ...
  return (
    <nav className={styles.sidebar} aria-label="ADR scene index">
...
export function getMetadata(lang: Lang): StyleMetadata {
  ...
  return {
    id: "decision-record",
    band: "text-report",
    name: lang === "zh" ? "决策记录" : "Decision Record",
...
export default function ChooseBoundaryV2({
  scene,
  beat,
  language,
  isThumbnail,
...
export const chooseBoundaryTopic = defineStyleTopic({
  id: "boundary",
  topic: {
    en: "Boundary",
    zh: "边界选择",
