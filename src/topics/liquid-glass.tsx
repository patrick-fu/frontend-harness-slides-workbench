...
function TopicStage({
  ...
  const renderNavDots = () => {
    ...
    return (
      <nav
        ...
        data-navigation-carrier="liquid-glass-scene-dots"
  ...
  return (
    <div data-topic-id="liquid-glass" className={rootClasses}>
            <SpatialSceneTrack
        scene={scene}
        beat={beat}
