// Template for style test files.
// Usage: copy this file, replace STYLE_ID, COMPONENT_NAME, FILE_SLUG, BEAT_COUNTS, and BAND.
//
// import { describe, it, expect, vi } from "vitest";
// import { render, screen, fireEvent } from "@testing-library/react";
// import COMPONENT_NAME, { getMetadata } from "./FILE_SLUG";
...
//
// describe("Style STYLE_ID: FILE_SLUG — render coverage", () => {
...
// });
//
// describe("Style STYLE_ID: FILE_SLUG — thumbnail mode", () => {
...
// });
//
// describe("Style STYLE_ID: FILE_SLUG — navigation presence", () => {
...
// });
//
// describe("Style STYLE_ID: FILE_SLUG — navigation behavior", () => {
...
// });
//
// describe("Style STYLE_ID: FILE_SLUG — overflow check", () => {
...
// });
//
// describe("Style STYLE_ID: FILE_SLUG — metadata structure", () => {
//   it("returns complete metadata", () => {
//     const meta = getMetadata("en");
//     expect(meta.id).toBe("STYLE_ID");
//     expect(meta.band).toBe("BAND_ID");
