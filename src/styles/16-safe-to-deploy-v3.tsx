...
import styles from "./16-safe-to-deploy-v3.module.css";

/* ────────────────────────────────────────────────────────────────────────
   Debug Reaction Board — v3 · "Is It Safe to Deploy?"
...
export function getMetadata(lang: Lang): StyleMetadata {
  const META: Record<Lang, StyleMetadata> = {
    en: {
      id: "16",
...
export const safeToDeployV3Version = defineStyleVersion({
  id: "v3",
...
export default DebugReactionBoardV3;
