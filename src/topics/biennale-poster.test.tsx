...
import definition from "./biennale-poster";
...
describe("Biennale Poster — render coverage", () => {
...
describe("Biennale Poster — thumbnail mode", () => {
...
describe("Biennale Poster — navigation presence", () => {
...
describe("Biennale Poster — navigation behavior", () => {
...
describe("Biennale Poster — overflow check", () => {
...
describe("Biennale Poster — metadata structure", () => {
  it("returns complete metadata", () => {
    const meta = metadataFor("en");
    expect(definition.id).toBe("biennale-poster");
    expect(definition.styleId).toBe("solar-biennale-poster");
    expect(definition.title).toEqual({ en: "Biennale Poster", zh: "双年展" });
