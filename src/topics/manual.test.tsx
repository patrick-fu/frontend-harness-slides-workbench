...
describe("Runbook Manual — render coverage", () => {
...
describe("Runbook Manual — thumbnail mode", () => {
...
describe("Runbook Manual — navigation presence", () => {
...
describe("Runbook Manual — navigation behavior", () => {
...
describe("Runbook Manual — overflow check", () => {
