...
import styles from "./solar-biennale-poster-iron-from-stars.module.css";
...
export default function IronFromStars({
  scene,
  beat,
  language,
  isThumbnail,
...
export const ironFromStarsTopic = defineStyleTopic({
  id: "iron-from-stars",
  topic: {
    en: "Iron from Stars",
    zh: "恒星炼铁",
