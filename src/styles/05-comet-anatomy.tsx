...
import styles from "./05-comet-anatomy.module.css";
...
export const COMET_ANATOMY_TRANSITION_SCORE = {
  "1->2": "linear-wipe",
  "2->3": "push-x",
  "3->4": "iris-open",
  "4->5": "dip-to-color",
...
export const COMET_ANATOMY_SOURCES = [
  {
...
function useFonts() {
  useEffect(() => {
    const id = "style-05-comet-anatomy-fonts";
...
export function getMetadata(language: Language): StyleMetadata {
  return {
    ...
    name: language === "zh" ? "蓝晒制图台" : "Cyanotype Drafting Table",
...
export default function CometAnatomy({
  scene,
  beat,
  language,
  isThumbnail,
...
export const cometAnatomyTopic = defineStyleTopic({
  id: "comet-anatomy",
  topic: {
    en: "Comet Anatomy",
    zh: "彗星解剖",
