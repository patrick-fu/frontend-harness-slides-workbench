...
const TIDE_MAP_TRANSITION_SCORE = {
  "1->2": "wipe",
  "2->3": "slide-x",
  "3->4": "fade",
  "4->5": "hard-cut",
...
const TRANSITION_MAP: SceneTransitionMap = TIDE_MAP_TRANSITION_SCORE;
...
function SealIndex({
  ...
  return (
    <nav
      className="wbfw25SealIndex"
      aria-label={language === "zh" ? "场景" : "Scenes"}
      data-topic-navigation="true"
      data-navigation-geometry="typographic-index"
      data-navigation-carrier="tide-map-seal-index"
...
export default defineTopic({
  ...
  transitionScore: TIDE_MAP_TRANSITION_SCORE,
  evidence: {
    kind: "illustrative",
    boundary: {
