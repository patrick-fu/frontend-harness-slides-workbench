...
function useFonts() {
  useEffect(() => {
    const id = "breathing-onboard-fonts";
...
const rootStyle = {
  "--breathing-onboard-bg": PALETTE.bg,
  "--breathing-onboard-ink": PALETTE.ink,
  "--breathing-onboard-accent": PALETTE.blush,
  containerType: "size",
  position: "relative",
  width: "100%",
  height: "100%",
  overflow: "hidden",
  background:
    "radial-gradient(circle at 20cqw 18cqh, rgba(255, 247, 238, 0.92), transparent 19cqw), radial-gradient(circle at 78cqw 26cqh, rgba(205, 231, 247, 0.58), transparent 18cqw), var(--breathing-onboard-bg)",
  color: "var(--breathing-onboard-ink)",
