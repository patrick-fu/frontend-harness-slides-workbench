...
import OrgChart, { getMetadata } from "./14-org-chart";
...
describe("Style 14: Org Chart — render coverage", () => {
...
describe("Style 14: Org Chart — thumbnail mode", () => {
...
describe("Style 14: Org Chart — navigation presence", () => {
...
describe("Style 14: Org Chart — navigation behavior", () => {
...
describe("Style 14: Org Chart — overflow check", () => {
...
describe("Style 14: Org Chart — metadata structure", () => {
  it("returns complete metadata", () => {
    const meta = getMetadata("en");
    expect(meta.id).toBe("collaborative-pairing-board");
