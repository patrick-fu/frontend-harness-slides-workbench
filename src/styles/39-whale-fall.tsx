...
import styles from "./39-whale-fall.module.css";
...
export const WHALE_FALL_TRANSITION_SCORE = {
  "1->2": "dip-to-color",
  "2->3": "dolly-pull",
  "3->4": "focus-swap",
  "4->5": "crossfade",
...
const TRANSITION_MAP: SceneTransitionMap = WHALE_FALL_TRANSITION_SCORE;

export const WHALE_FALL_SOURCES = [
  {
...
function useFonts() {
  useEffect(() => {
    const id = "style-39-whale-fall-fonts";
...
export function getMetadata(language: Language): StyleMetadata {
  return {
    ...
    name: language === "zh" ? "宽银幕标题卡" : "Widescreen Title Card",
...
function FilmstripNavigation({
  ...
  return (
    <nav
      ...
      data-navigation-carrier="whale-fall-filmstrip"
...
export default function WhaleFall({
  scene,
  beat,
  language,
  isThumbnail,
...
export const whaleFallTopic = defineStyleTopic({
  id: "whale-fall",
  topic: {
    en: "Whale Fall",
    zh: "鲸落",
  ...
  transitionScore: WHALE_FALL_TRANSITION_SCORE,
});
