...
import definition from "./subway-flow";
...
describe("Subway Flow — render coverage", () => {
...
describe("Subway Flow — thumbnail mode", () => {
...
describe("Subway Flow — navigation presence", () => {
...
describe("Subway Flow — navigation behavior", () => {
...
describe("Subway Flow — overflow check", () => {
