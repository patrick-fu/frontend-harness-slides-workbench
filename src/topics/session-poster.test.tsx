...
import definition from "./session-poster";
...
describe("Session Poster — render coverage", () => {
...
describe("Session Poster — thumbnail mode", () => {
...
describe("Session Poster — navigation presence", () => {
...
describe("Session Poster — navigation behavior", () => {
...
describe("Session Poster — overflow check", () => {
...
describe("Session Poster — metadata structure", () => {
  it("returns complete metadata", () => {
    const meta = metadataFor("en");
    expect(definition.id).toBe("session-poster");
    expect(definition.styleId).toBe("duotone-session");
    expect(definition.title).toEqual({ en: "Session Poster", zh: "录制海报" });
