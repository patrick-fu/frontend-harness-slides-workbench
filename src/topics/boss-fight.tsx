...
function TopicStage({
  ...
  useEffect(() => {
    const FONT_ID = "boss-fight-fonts-arcade";
  ...
  const renderNavDots = () => {
    ...
    return (
      <nav
        ...
        data-navigation-carrier="boss-fight-scene-dots"
  ...
  return (
    <div data-testid="boss-fight-root" className={rootClasses}>
            <SpatialSceneTrack
        scene={scene}
        beat={beat}
