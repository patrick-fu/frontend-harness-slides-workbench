...
import topic from "./vocal-folds";
import componentSource from "./vocal-folds.tsx?raw";
import cssSource from "./vocal-folds.module.css?inline";

runTopicContract(topic);

const Stage = topic.Stage;

function factSources(): readonly Source[] {
  if (topic.evidence.kind !== "facts") {
    throw new Error("Vocal Folds must define facts Evidence.");
  }
  return topic.evidence.sources;
}

const VOCAL_FOLDS_SOURCES = factSources();
...
describe("Vocal Folds — stage mechanism and evidence", () => {
...
describe("Vocal Folds — stage-plan navigation", () => {
...
describe("Vocal Folds — motion and fixed-stage safety", () => {
