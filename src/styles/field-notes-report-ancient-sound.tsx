...
import styles from "./field-notes-report-ancient-sound.module.css";
...
type AncientSoundSource = TopicSource & {
  id: string;
...
export function getMetadata(language: Language): StyleMetadata {
  return {
    ...
    band: "text-report",
    name: language === "zh" ? "田野笔记报告" : "Field Notes Report",
...
export default function AncientSoundFieldNotes({
  scene,
  beat,
  language,
  isThumbnail,
...
export const ancientSoundTopic = defineStyleTopic({
  id: "ancient-sound",
  topic: {
    en: "Ancient Sound",
    zh: "古代声音",
