...
function useFonts() {
  useEffect(() => {
    ...
    const id = "style-24-archive-reassembled-v2-fonts";
...
export function getMetadata(lang: Lang): StyleMetadata {
  ...
  return {
    ...
    name: lang === "zh" ? "模拟剪贴拼贴" : "Analog Cutout Collage",
...
export default function ArchiveReassembledV2({
  scene,
  beat,
  language,
  isThumbnail,
...
export const archiveReassembledTopic = defineStyleTopic({
  id: "rebuilt-archive",
  topic: {
    en: "Rebuilt Archive",
    zh: "重组档案",
