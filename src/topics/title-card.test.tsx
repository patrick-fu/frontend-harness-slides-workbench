...
describe("Title Card — render coverage", () => {
...
describe("Title Card — thumbnail mode", () => {
...
describe("Title Card — navigation presence", () => {
...
describe("Title Card — navigation behavior", () => {
...
describe("Title Card — overflow check", () => {
