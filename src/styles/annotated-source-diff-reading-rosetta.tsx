...
import styles from "./annotated-source-diff-reading-rosetta.module.css";
...
function metadataScenes(language: Language): StyleMetadata["scenes"] {
...
export function getMetadata(language: Language): StyleMetadata {
  return {
    ...
    band: "text-report",
    name: language === "zh" ? "带批注的来源对照" : "Annotated Source & Diff",
...
function RosettaSymbolMinimap({
  ...
  return (
    <nav
      ...
      data-navigation-carrier="rosetta-symbol-minimap"
...
export default function ReadingRosetta({
  scene,
  beat,
  language,
  isThumbnail,
...
export const readingRosettaTopic = defineStyleTopic({
  id: "reading-rosetta",
  topic: {
    en: "Reading Rosetta",
    zh: "破译罗塞塔",
