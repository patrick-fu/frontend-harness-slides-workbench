...
import definition from "./mixing-console";
...
describe("Mixing Console — render coverage", () => {
...
describe("Mixing Console — thumbnail mode", () => {
...
describe("Mixing Console — navigation presence", () => {
...
describe("Mixing Console — navigation behavior", () => {
...
describe("Mixing Console — overflow check", () => {
...
describe("Mixing Console — metadata structure", () => {
  it("retains complete metadata", () => {
    const meta = definition.metadata.en;
    expect(definition.id).toBe("mixing-console");
    expect(definition.styleId).toBe("studio-mixing-console");
