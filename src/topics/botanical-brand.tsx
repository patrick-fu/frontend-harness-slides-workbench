...
import styles from "./botanical-brand.module.css";

// ─── Font Injection ────────────────────────────────────────────────────────

function useFonts() {
  useEffect(() => {
    const id = "botanical-brand-fonts";
  ...
  const renderNavIndicators = () => {
    ...
    return (
      <div
        ...
        data-navigation-carrier="botanical-brand-scene-indicators"
...
export default defineTopic({
  ...
  title: { en: "Botanical Brand", zh: "植物品牌" },
