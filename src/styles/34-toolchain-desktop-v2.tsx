    ...
    scenes: {
      ...
      2: {
        ...
        panels: [
          {
            title: "CODE.EXE",
            lines: ["src/styles/34-toolchain-desktop-v2.tsx", "renderScene(scene, beat)", "export version module"],
            tone: "navy",
          },
          {
            title: "PKGMAN95",
    ...
    scenes: {
      ...
      2: {
        ...
        panels: [
          {
            title: "CODE.EXE",
            lines: ["src/styles/34-toolchain-desktop-v2.tsx", "renderScene(scene, beat)", "导出 version module"],
            tone: "navy",
          },
          {
            title: "PKGMAN95",
...
function Taskbar({
  ...
  return (
    <nav className="tw34-taskbar" aria-label={copy.navLabel}>
...
export function getMetadata(lang: Lang): StyleMetadata {
  ...
  return {
    ...
    name: lang === "zh" ? "复古 Windows" : "Retro Windows",
...
export default function ToolchainDesktopV2({
  scene,
  beat,
  language,
  isThumbnail,
