...
const CONTENT: Record<Lang, { theme: string; density: string; scenes: SceneText[] }> = {
  en: {
...
const rootStyle = {
  "--launch-ledger-bg": PALETTE.bg,
  "--launch-ledger-ink": PALETTE.ink,
  "--launch-ledger-panel": PALETTE.paper,
  "--launch-ledger-accent": PALETTE.green,
  position: "relative",
  width: "100%",
  height: "100%",
  overflow: "hidden",
  containerType: "size",
  backgroundColor: "var(--launch-ledger-bg)",
  backgroundImage:
...
export default defineTopic({
  ...
  title: { en: "Launch Ledger", zh: "发布台账" },
  modelId: "GPT 5.5",
  Stage: TopicStage,
  metadata: METADATA,
