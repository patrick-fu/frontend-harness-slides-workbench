...
const transitionMap: SceneTransitionMap = TRANSITION_SCORE;
...
function useFonts() {
  useEffect(() => {
    const id = "infrastructure-gala-fonts";
...
function ElevatorNav({
  ...
  return (
    <nav
      ...
      data-navigation-carrier="brass-elevator"
...
function TopicStage({
  ...
  return (
    <div style={rootStyle(quiet)} data-topic-id="infrastructure-gala">
      <Backdrop />
      <SpatialSceneTrack
        scene={activeScene}
        beat={activeBeat}
