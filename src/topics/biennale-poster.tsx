...
import styles from "./biennale-poster.module.css";
...
function TopicStage({
  ...
  // Font injection
  useEffect(() => {
    const id = "biennale-poster-fonts";
  ...
  const renderNavIndicators = () => {
    ...
    return (
      <div
        ...
        data-navigation-carrier="biennale-poster-node-ring"
...
export default defineTopic({
  ...
  title: { en: "Biennale Poster", zh: "双年展" },
