...
import risoZine from "./riso-zine";

const { Stage } = risoZine;

runTopicContract(risoZine);
...
describe("Riso Zine — render coverage", () => {
...
describe("Riso Zine — thumbnail mode", () => {
...
describe("Riso Zine — navigation presence", () => {
...
describe("Riso Zine — navigation behavior", () => {
...
describe("Riso Zine — overflow check", () => {
...
describe("Riso Zine — metadata structure", () => {
  it("returns complete metadata", () => {
    const meta = risoZine.metadata.en;
    expect(risoZine.styleId).toBe("riso-print-zine");
    expect(risoZine.title).toEqual({ en: "Riso Zine", zh: "孔版杂志" });
