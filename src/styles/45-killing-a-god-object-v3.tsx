...
/* ────────────────────────────────────────────────────────────────────────
   Style 45 · "Annotated Source & Diff" · v3 topic: Killing a God Object
...
export function getMetadata(lang: Lang): StyleMetadata {
  ...
  return {
    id: "45",
    band: "text-report",
    name: en ? "Annotated Source & Diff" : "注解源码与差异",
...
export default KillingAGodObjectV3;

export const KillingAGodObjectV3Version = defineStyleVersion({
  id: "v3",
