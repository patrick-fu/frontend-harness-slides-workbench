...
import styles from "./riso-print-zine-seven-blues.module.css";
...
interface BlueSource extends TopicSource {
  id: SourceId;
...
function BlueSwatchNavigation({
  ...
  return (
    <nav
      ...
      data-navigation-carrier="blue-pigment-swatches"
...
export function getMetadata(language: Lang): StyleMetadata {
  return {
    ...
    name: language === "zh" ? "孔版印刷小志" : "Riso Print Zine",
...
export default function RisoPrintZineSevenBlues({
  scene,
  beat,
  language,
  isThumbnail,
...
export const sevenBluesTopic = defineStyleTopic({
  id: "seven-blues",
  topic: {
    en: "Seven Blues",
    zh: "七种蓝",
