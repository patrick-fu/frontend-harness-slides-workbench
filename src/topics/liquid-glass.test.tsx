...
import definition from "./liquid-glass";
...
describe("Liquid Glass — render coverage", () => {
...
describe("Liquid Glass — thumbnail mode", () => {
...
describe("Liquid Glass — navigation presence", () => {
...
describe("Liquid Glass — navigation behavior", () => {
...
describe("Liquid Glass — overflow check", () => {
...
describe("Liquid Glass — metadata structure", () => {
  it("keeps complete canonical metadata", () => {
    const meta = definition.metadata.en;
    expect(definition.id).toBe("liquid-glass");
