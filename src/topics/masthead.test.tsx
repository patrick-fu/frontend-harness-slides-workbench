...
describe("Masthead — render coverage", () => {
...
describe("Masthead — thumbnail mode", () => {
...
describe("Masthead — navigation presence", () => {
...
describe("Masthead — navigation behavior", () => {
...
describe("Masthead — overflow check", () => {
...
describe("Masthead — metadata structure", () => {
  it("returns complete metadata", () => {
    const meta = topic.metadata.en;
    expect(topic.id).toBe("masthead");
    expect(topic.styleId).toBe("magazine-masthead");
    expect(topic.title).toEqual({ en: "Masthead", zh: "杂志刊头" });
