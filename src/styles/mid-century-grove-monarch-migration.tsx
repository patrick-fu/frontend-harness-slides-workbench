...
import styles from "./mid-century-grove-monarch-migration.module.css";
...
export const MONARCH_MIGRATION_TRANSITION_SCORE = {
  "1->2": "push-y",
  "2->3": "push-x",
  "3->4": "focus-swap",
  "4->5": "push-y",
...
export const MONARCH_MIGRATION_SOURCES = [
  {
...
export function getMetadata(language: Language): StyleMetadata {
  return {
    ...
    name: language === "zh" ? "世纪中叶林园" : "Mid-Century Grove",
...
export default function MonarchMigration({
  scene,
  beat,
  language,
  isThumbnail,
...
export const monarchMigrationTopic = defineStyleTopic({
