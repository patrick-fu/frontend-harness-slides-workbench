...
import typePoster from "./type-poster";
import type { TopicStageProps } from "../domain/topic";
import { runTopicContract } from "../testing/topic-contract";

const { Stage } = typePoster;

runTopicContract(typePoster);
...
describe("Type Poster — render coverage", () => {
...
describe("Type Poster — thumbnail mode", () => {
...
describe("Type Poster — navigation presence", () => {
...
describe("Type Poster — navigation behavior", () => {
...
describe("Type Poster — overflow check", () => {
...
describe("Type Poster — metadata structure", () => {
  it("returns complete metadata", () => {
    const meta = typePoster.metadata.en;
    expect(typePoster.styleId).toBe("kinetic-type-punchline");
    expect(typePoster.title).toEqual({ en: "Type Poster", zh: "字体海报" });
