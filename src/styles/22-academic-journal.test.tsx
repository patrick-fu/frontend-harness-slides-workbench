...
import AcademicJournal22, { getMetadata } from "./22-academic-journal";
...
function renderStage(props: Partial<BespokeStyleProps> = {}) {
  ...
  const { container, ...rest } = render(
    <div style={{ width: 1920, height: 1080, containerType: "size",
      ...
      <AcademicJournal22 {...defaultProps} />
    </div>,
  );
...
describe("Style 22: academic-journal — render coverage", () => {
...
describe("Style 22: academic-journal — thumbnail mode", () => {
...
describe("Style 22: academic-journal — navigation presence", () => {
...
describe("Style 22: academic-journal — navigation behavior", () => {
...
describe("Style 22: academic-journal — overflow check", () => {
