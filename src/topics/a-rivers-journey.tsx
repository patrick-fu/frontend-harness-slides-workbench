...
const A_RIVERS_JOURNEY_TRANSITION_SCORE = {
  "1->2": "slide-x",
  "2->3": "slide-x",
  "3->4": "slide-x",
  "4->5": "fade",
...
const TRANSITIONS: SceneTransitionMap = A_RIVERS_JOURNEY_TRANSITION_SCORE;
...
function HorizonNav({
  ...
  return (
    <div
      ...
      data-navigation-carrier="river-horizon-boat"
...
export default defineTopic({
  ...
  transitionScore: A_RIVERS_JOURNEY_TRANSITION_SCORE,
  evidence: {
    kind: "illustrative",
    boundary: {
