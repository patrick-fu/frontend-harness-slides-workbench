...
import styles from "./04-vocal-folds.module.css";
...
export const VOCAL_FOLDS_TRANSITION_SCORE = {
  "1->2": "split-merge",
  "2->3": "focus-swap",
  "3->4": "grid-reveal",
  "4->5": "split-merge",
...
export const VOCAL_FOLDS_SOURCES = [
  {
    authority:
...
function useFonts(): void {
  useEffect(() => {
    const id = "style-04-vocal-folds-fonts";
...
export function getMetadata(language: Language): StyleMetadata {
  return {
    ...
    name:
      language === "zh" ? "互动对话舞台" : "Interactive Dialogue Stage",
...
export default function VocalFolds({
  scene,
  beat,
  language,
  isThumbnail,
...
export const vocalFoldsTopic = defineStyleTopic({
  id: "vocal-folds",
  topic: {
    en: "Vocal Folds",
    zh: "声带",
  ...
  transitionScore: VOCAL_FOLDS_TRANSITION_SCORE,
});
