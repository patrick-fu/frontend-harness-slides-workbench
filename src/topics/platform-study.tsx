      ...
      {visibleNotes.map((note, index) => (
        <article
          ...
          style={{
            ...
            animation: motionOff
              ? "none"
              : `platform-study-note-in 520ms cubic-bezier(0.2, 0.8, 0.24, 1) ${index * 70}ms both`,
          }}
        >
    ...
    <div style={styles.coverArea} data-beat-layout-item="true">
      ...
      <p
        style={{
          ...
          opacity: beat > 0 ? 1 : 0,
          animation: motionOff || beat === 0 ? "none" : "platform-study-pencil 560ms ease both",
        }}
      >
        {copy.sketchLabel}
      </p>
  ...
  return (
    <div style={styles.sketchPanel} data-beat-layout-item="true">
      ...
      <p
        style={{
          ...styles.sketchCaption,
          animation: motionOff ? "none" : "platform-study-pencil 560ms ease both",
        }}
      >
        {copy.sketchLabel}
      </p>
...
function EdgeFlags({
  ...
  return (
    <nav
      aria-label="Notebook scene flags"
      style={styles.edgeFlags}
...
const MOTION_CSS = `
@keyframes platform-study-note-in {
  from { opacity: 0; transform: translateY(1.8cqh) rotate(-0.4deg); }
  to { opacity: 1; transform: translateY(0) rotate(0); }
}
@keyframes platform-study-pencil {
  from { opacity: 0; clip-path: inset(0 100% 0 0); }
  to { opacity: 1; clip-path: inset(0 0 0 0); }
}
[data-platform-study-root][data-motion="off"] * {
