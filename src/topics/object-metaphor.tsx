...
import styles from "./object-metaphor.module.css";
...
function TopicStage({
  ...
  useEffect(() => {
    const id = "object-metaphor-fonts";
  ...
  const renderNav = () => {
    ...
    return (
      <nav
        ...
        data-navigation-carrier="object-metaphor-scene-index"
