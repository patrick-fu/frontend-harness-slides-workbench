...
import styles from "./43-ready-agent-pickup-v2.module.css";
  ...
  en: {
    1: {
      ...
      side: [
        ...
        { label: "Surface", detail: "style 43 curated v2" },
    ...
    3: {
      ...
      summary:
        "The fix is limited to the v2 version module and its optional CSS module.",
      primaryLabel: "In scope",
      secondaryLabel: "Out of scope",
      steps: [
        {
          label: "Create version module",
          detail: "Export v2 metadata, five scenes, beats, and the component.",
          code: "43-ready-agent-pickup-v2.tsx",
        },
        {
    ...
    4: {
      ...
      steps: [
        {
          label: "Protocol",
          detail: "Define v2, bilingual metadata, and reserved multi-beat containers.",
          code: "[x] defineStyleVersion({ id: \"v2\" })",
        },
        {
          label: "Presentation",
  ...
  zh: {
    1: {
      ...
      side: [
        ...
        { label: "范围", detail: "style 43 curated v2" },
    ...
    3: {
      ...
      status: "已收束",
      title: "工作集是显性的",
      summary: "修复仅限 v2 版本模块和可选 CSS module。",
      primaryLabel: "范围内",
      secondaryLabel: "范围外",
      steps: [
        {
          label: "创建版本模块",
          detail: "导出 v2 metadata、五个场景、beats 和组件。",
          code: "43-ready-agent-pickup-v2.tsx",
        },
        {
          label: "编写 tracker 视觉",
    ...
    4: {
      ...
      steps: [
        {
          label: "协议",
          detail: "定义 v2、双语 metadata、reserved multi-beat 容器。",
          code: "[x] defineStyleVersion({ id: \"v2\" })",
        },
        {
          label: "表达",
...
const metadataScenes: Record<Language, StyleMetadata["scenes"]> = {
  en: [
    {
      id: 1,
      title: "Issue",
      ...
      beats: [
        {
          ...
          title: "The working set is explicit",
          body: "Only the version module and optional CSS module are in scope.",
        },
        {
          id: 1,
      ...
      beats: [
        {
          ...
          title: "Protocol",
          body: "Define v2 and complete bilingual metadata.",
        },
        {
          id: 1,
      ...
      beats: [
        {
          ...
          action: "列出工作集",
          title: "工作集是显性的",
          body: "只有版本模块和可选 CSS module 在范围内。",
        },
        {
          id: 1,
          action: "圈定非目标",
    ...
    >
      <header className={styles.issueHeader} data-beat-layout-item="true">
        <div className={styles.issueKicker}>
          ...
          <span className={styles.pathText}>src/styles/43-ready-agent-pickup-v2.tsx</span>
        </div>
...
function TicketStatusNav({
  ...
  return (
    <nav className={styles.statusNav} aria-label="Ticket status navigation">
...
export function getMetadata(lang: Language): StyleMetadata {
  return {
    id: "43",
    band: "text-report",
    name: lang === "zh" ? "维护者 Issue 简报" : "Maintainer Issue Brief",
...
export default function ReadyAgentPickupV2({
  scene,
  beat,
  language,
  isThumbnail,
