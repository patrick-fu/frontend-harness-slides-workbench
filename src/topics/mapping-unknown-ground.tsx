...
function AltitudeScale({
  ...
  return (
    <div
      ...
      data-navigation-carrier="expedition-altitude-scale"
...
function TopicStage({
  ...
  return (
    <div
      className={`${styles.root} ${still ? styles.static : ""}`}
      data-topic-id="mapping-unknown-ground"
    >
      <SpatialSceneTrack
        scene={scene}
        beat={beat}
...
export default defineTopic({
  ...
  title: { en: "Mapping Unknown Ground", zh: "勘探未知" },
