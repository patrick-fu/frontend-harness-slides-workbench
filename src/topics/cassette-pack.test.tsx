...
import definition from "./cassette-pack";
...
describe("Cassette Pack — render coverage", () => {
...
describe("Cassette Pack — thumbnail mode", () => {
...
describe("Cassette Pack — navigation presence", () => {
...
describe("Cassette Pack — navigation behavior", () => {
...
describe("Cassette Pack — overflow check", () => {
