...
import styles from "./session-poster.module.css";
  ...
  const renderNavIndicators = () => {
    ...
    return (
      <div
        ...
        data-navigation-carrier="session-poster-node-ring"
...
export default defineTopic({
  ...
  title: { en: "Session Poster", zh: "录制海报" },
