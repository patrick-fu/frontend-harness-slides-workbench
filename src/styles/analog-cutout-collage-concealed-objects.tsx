...
import styles from "./analog-cutout-collage-concealed-objects.module.css";
...
interface ConcealedObjectsSource extends TopicSource {
...
function WallCacheNavigation({
  ...
  return (
    <nav
      ...
      data-navigation-carrier="wall-cache-fragments"
...
export function getMetadata(language: Language): StyleMetadata {
  ...
  return {
    ...
    band: "craft-cultural",
    name: language === "zh" ? "模拟剪纸拼贴" : "Analog Cutout Collage",
...
export default function ConcealedObjects({
  scene,
  beat,
  language,
  isThumbnail,
