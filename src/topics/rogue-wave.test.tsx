...
import componentSource from "./rogue-wave.tsx?raw";
...
describe("Rogue Wave topic contract", () => {
  it("exports the canonical topic metadata and exact transition score", () => {
    expect(topic.id).toBe("rogue-wave");
    expect(topic.title).toEqual({ en: "Rogue Wave", zh: "怪浪" });
...
describe("Rogue Wave motion and stage safety", () => {
  it("contains no loops, remote visual assets, clone rendering, or unsafe stage units", () => {
