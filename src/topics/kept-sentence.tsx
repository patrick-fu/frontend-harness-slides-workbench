...
const rootStyle = {
  "--kept-sentence-bg": COLORS.bg,
  "--kept-sentence-ink": COLORS.ink,
  "--kept-sentence-muted": COLORS.muted,
  "--kept-sentence-panel": COLORS.panel,
  "--kept-sentence-paper": COLORS.paper,
  "--kept-sentence-paper-ink": COLORS.paperInk,
  "--kept-sentence-shadow": COLORS.shadow,
  "--kept-sentence-accent": COLORS.accent,
  "--kept-sentence-footlight": COLORS.footlight,
  position: "relative",
  width: "100cqw",
  height: "100cqh",
  containerType: "size",
  overflow: "hidden",
  background: "var(--kept-sentence-bg)",
  color: "var(--kept-sentence-ink)",
    ...
    >
      ...
      >
        ...
        <QuoteLines
          lines={content.quote}
          language={language}
          color="var(--kept-sentence-paper-ink)"
          visible={beat >= 1}
          motionDisabled={motionDisabled}
      ...
      >
        ...
        <div
          ...
          style={{
            ...
            right: "6cqw",
            top: "13cqh",
            color: "var(--kept-sentence-accent)",
            fontFamily:
              language === "zh"
                ? "\"Noto Serif SC\", serif"
  ...
  return (
    <div
      ...
      style={{
        ...
        color: isPaper
          ? "var(--kept-sentence-paper-ink)"
          : "var(--kept-sentence-ink)",
        boxShadow: isPaper
...
const kickerStyle: CSSProperties = {
  color: "var(--kept-sentence-footlight)",
  fontSize: "1.15cqw",
  lineHeight: 1.4,
          ...
          >
            <span
              ...
              style={{
                ...
                borderRadius: "999cqw",
                background: "var(--kept-sentence-footlight)",
                boxShadow: active
