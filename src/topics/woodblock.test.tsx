...
describe("Woodblock — render coverage", () => {
...
describe("Woodblock — thumbnail mode", () => {
...
describe("Woodblock — navigation presence", () => {
...
describe("Woodblock — navigation behavior", () => {
...
describe("Woodblock — overflow check", () => {
