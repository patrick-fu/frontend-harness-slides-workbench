...
import styles from "./07-how-we-named-it-v3.module.css";
...
export function getMetadata(lang: Lang): StyleMetadata {
  ...
  return {
    ...
    name: en ? "Sketch Board Emoji" : "草图白板表情",
    theme: T.title[lang],
...
export default SketchBoardEmojiV3;

export const sketchBoardEmojiV3Version = defineStyleVersion({
  id: "v3",
