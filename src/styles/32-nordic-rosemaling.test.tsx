...
import NordicRosemaling32, { getMetadata } from "./32-nordic-rosemaling";
...
function renderStage(props: Partial<BespokeStyleProps> = {}) {
  ...
  const { container, ...rest } = render(
    <div style={{ width: 1920, height: 1080, containerType: "size",
      ...
      <NordicRosemaling32 {...defaultProps} />
    </div>,
  );
...
describe("Style 32: 32-nordic-rosemaling — render coverage", () => {
...
describe("Style 32: 32-nordic-rosemaling — thumbnail mode", () => {
...
describe("Style 32: 32-nordic-rosemaling — navigation presence", () => {
...
describe("Style 32: 32-nordic-rosemaling — navigation behavior", () => {
...
describe("Style 32: 32-nordic-rosemaling — overflow check", () => {
...
describe("Style 32: 32-nordic-rosemaling — metadata structure", () => {
  it("returns complete metadata", () => {
    const meta = getMetadata("en");
    expect(meta.id).toBe("mechanical-scoring-funnel");
