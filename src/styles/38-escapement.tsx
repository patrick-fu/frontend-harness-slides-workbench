...
import styles from "./38-escapement.module.css";
...
export const ESCAPEMENT_TRANSITION_SCORE = {
  "1->2": "hard-cut",
  "2->3": "linear-wipe",
  "3->4": "iris-open",
  "4->5": "focus-swap",
...
const TRANSITION_MAP: SceneTransitionMap = ESCAPEMENT_TRANSITION_SCORE;
...
export const ESCAPEMENT_SOURCES = [
  {
...
function metadataScenes(language: Lang): StyleMetadata["scenes"] {
...
export function getMetadata(language: Lang): StyleMetadata {
  return {
    ...
    name: language === "zh" ? "操作手册" : "Operating Manual",
...
export default function Escapement({
  ...
  return (
    <div
      ...
      data-topic-origin="coordinated-topic-set"
      data-motion={reduce ? "off" : "on"}
...
export const escapementTopic = defineStyleTopic({
  id: "escapement",
  topic: {
    en: "The Escapement",
    zh: "擒纵器",
  ...
  transitionScore: ESCAPEMENT_TRANSITION_SCORE,
});
