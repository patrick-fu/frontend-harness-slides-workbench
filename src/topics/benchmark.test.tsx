...
import definition from "./benchmark";
...
describe("Benchmark — render coverage", () => {
...
describe("Benchmark — thumbnail mode", () => {
...
describe("Benchmark — navigation presence", () => {
...
describe("Benchmark — navigation behavior", () => {
...
describe("Benchmark — overflow check", () => {
...
describe("Benchmark — metadata structure", () => {
  it("returns complete metadata", () => {
    const meta = definition.metadata.en;
    expect(definition.styleId).toBe("benchmark-matrix");
    expect(definition.title).toEqual({ en: "Benchmark", zh: "基准评估" });
