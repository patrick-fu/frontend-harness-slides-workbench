...
import styles from "./09-tea-cha-routes.module.css";
...
export function getMetadata(lang: Lang): StyleMetadata {
  ...
  return {
    ...
    name: isZh ? "意图地铁图" : "Subway Map of Intent",
...
export default function TeaChaRoutes({
  scene,
  beat,
  language,
  isThumbnail,
...
export const teaChaRoutesTopic = defineStyleTopic({
  id: "tea-cha-routes",
  topic: {
    en: "Tea / Cha",
    zh: "茶与 Cha",
