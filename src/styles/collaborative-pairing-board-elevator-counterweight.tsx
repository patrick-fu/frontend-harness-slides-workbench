...
import styles from "./collaborative-pairing-board-elevator-counterweight.module.css";
...
interface ElevatorCounterweightSource extends TopicSource {
...
export default function ElevatorCounterweight({
  scene,
  beat,
  language,
  isThumbnail,
...
export const elevatorCounterweightTopic = defineStyleTopic({
