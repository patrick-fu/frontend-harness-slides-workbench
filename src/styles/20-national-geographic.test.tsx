...
import NationalGeographic20, { getMetadata } from "./20-national-geographic";
...
function renderStage(props: Partial<BespokeStyleProps> = {}) {
  ...
  const { container, ...rest } = render(
    <div style={{ width: 1920, height: 1080, containerType: "size",
      ...
      <NationalGeographic20 {...defaultProps} />
    </div>,
  );
...
describe("Style 20: national-geographic — render coverage", () => {
...
describe("Style 20: national-geographic — thumbnail mode", () => {
...
describe("Style 20: national-geographic — navigation presence", () => {
...
describe("Style 20: national-geographic — navigation behavior", () => {
...
describe("Style 20: national-geographic — overflow check", () => {
...
describe("Style 20: national-geographic — metadata structure", () => {
  it("returns complete metadata", () => {
    const meta = getMetadata("en");
    expect(meta.id).toBe("scholars-vellum");
