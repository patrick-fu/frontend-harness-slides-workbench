...
import componentSource from "./acoustic-crack.tsx?raw";
import styleClasses from "./acoustic-crack.module.css";
...
const styleSource = readFileSync(
  "src/topics/acoustic-crack.module.css",
  "utf8",
);
...
describe("Debug Reaction Board / Acoustic Crack — protocol", () => {
  it("declares the exact topic, evidence packet, transition score, navigation, and bilingual beat curve", () => {
    expect(definition.id).toBe("acoustic-crack");
