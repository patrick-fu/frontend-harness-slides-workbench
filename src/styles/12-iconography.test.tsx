...
import Iconography, { getMetadata } from "./12-iconography";
...
describe("Style 12: Iconography — render coverage", () => {
...
describe("Style 12: Iconography — thumbnail mode", () => {
...
describe("Style 12: Iconography — navigation presence", () => {
...
describe("Style 12: Iconography — navigation behavior", () => {
...
describe("Style 12: Iconography — overflow check", () => {
...
describe("Style 12: Iconography — metadata structure", () => {
  it("returns complete metadata", () => {
    const meta = getMetadata("en");
    expect(meta.id).toBe("soft-pastel-friendly");
