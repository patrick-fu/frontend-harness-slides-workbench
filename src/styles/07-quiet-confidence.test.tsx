...
import QuietConfidence, { getMetadata } from "./07-quiet-confidence";
...
describe("Style 07: Quiet Confidence — render coverage", () => {
...
describe("Style 07: Quiet Confidence — thumbnail mode", () => {
...
describe("Style 07: Quiet Confidence — navigation presence", () => {
...
describe("Style 07: Quiet Confidence — navigation behavior", () => {
...
describe("Style 07: Quiet Confidence — metadata structure", () => {
  it("returns complete metadata", () => {
    const meta = getMetadata("en");
    expect(meta.id).toBe("sketch-board-emoji");
