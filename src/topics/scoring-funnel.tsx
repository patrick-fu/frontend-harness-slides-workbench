...
import styles from "./scoring-funnel.module.css";

function useFonts() {
  useEffect(() => {
    const id = "scoring-funnel-fonts";
  ...
  const renderNav = () => {
    ...
    return (
      <div
        ...
        data-navigation-carrier="scoring-funnel-step-lights"
...
export default defineTopic({
  ...
  title: { en: "Scoring Funnel", zh: "评分漏斗" },
