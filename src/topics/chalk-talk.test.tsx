...
describe("Chalk Talk — render coverage", () => {
...
describe("Chalk Talk — thumbnail mode", () => {
...
describe("Chalk Talk — navigation presence", () => {
...
describe("Chalk Talk — navigation behavior", () => {
...
describe("Chalk Talk — overflow check", () => {
...
describe("Chalk Talk — metadata structure", () => {
  it("returns complete metadata", () => {
    const meta = topic.metadata.en;
    expect(topic.id).toBe("chalk-talk");
