...
import styles from "./24-piecing-idea-together-v3.module.css";
...
/* ── Bilingual content (getMetadata + scene visuals share this) ─────── */
...
function AnalogCutoutCollageV3({
  scene,
  beat,
  language,
  isThumbnail,
...
export const piecingIdeaTogetherV3Version = defineStyleVersion({
  id: "v3",
...
export default AnalogCutoutCollageV3;
