...
import styles from "./brutalist-bulletin.module.css";

function useFonts() {
  useEffect(() => {
    const id = "brutalist-bulletin-fonts";
  ...
  const renderNav = () => {
    ...
    return (
      <div
        ...
        data-navigation-carrier="brutalist-bulletin-tabs"
...
export default defineTopic({
  ...
  title: { en: "Brutalist Bulletin", zh: "粗野公告" },
