...
import styles from "./46-close-the-quarter-v3.module.css";
...
export default CloseTheQuarter;

export const CloseTheQuarterV3Version = defineStyleVersion({
  id: "v3",
