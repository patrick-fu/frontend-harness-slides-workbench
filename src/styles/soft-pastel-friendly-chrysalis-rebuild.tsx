...
import styles from "./soft-pastel-friendly-chrysalis-rebuild.module.css";
...
export default function ChrysalisRebuild({
  scene,
  beat,
  language,
  isThumbnail,
...
export const chrysalisRebuildTopic = defineStyleTopic({
