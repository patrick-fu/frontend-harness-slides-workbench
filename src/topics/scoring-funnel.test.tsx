...
import topic from "./scoring-funnel";
...
describe("Scoring Funnel render coverage", () => {
...
describe("Scoring Funnel thumbnail mode", () => {
...
describe("Scoring Funnel navigation", () => {
...
describe("Scoring Funnel stage boundary", () => {
...
describe("Scoring Funnel metadata", () => {
  it("keeps the authored scene curve and Topic identity", () => {
    ...
    expect(topic.title).toEqual({ en: "Scoring Funnel", zh: "评分漏斗" });
