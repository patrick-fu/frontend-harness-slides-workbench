...
const TOPIC_ID = "tcp-congestion-control";
...
function useFonts() {
  useEffect(() => {
    const id = "style-engineering-whiteboard-tcp-fonts";
    if (document.getElementById(id)) return;
    const link = document.createElement("link");
    link.id = id;
    link.rel = "stylesheet";
    link.href =
      "https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&family=JetBrains+Mono:wght@400;500;600;700&family=LXGW+WenKai:wght@400;700&family=Caveat:wght@400;600;700&family=Ma+Shan+Zheng&family=Space+Grotesk:wght@400;500;600;700&display=swap";
...
export default function EngineeringWhiteboardTcp({
  scene,
  beat,
  language,
  isThumbnail,
    ...
    >
      <SpatialSceneTrack
        ...
        renderScene={(sceneId, sceneBeat) =>
          renderScene(sceneId, sceneBeat, language, reducedMotion || isThumbnail)
        }
      />
    </div>
  );
...
export const tcpCongestionControlTopic = defineStyleTopic({
  id: TOPIC_ID,
  topic: {
  ...
  component: EngineeringWhiteboardTcp,
  getMetadata,
