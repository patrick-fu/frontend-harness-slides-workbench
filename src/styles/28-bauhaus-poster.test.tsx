...
import BauhausPoster28, { getMetadata } from "./28-bauhaus-poster";
...
describe("Style 28: 28-bauhaus-poster — render coverage", () => {
...
describe("Style 28: 28-bauhaus-poster — thumbnail mode", () => {
...
describe("Style 28: 28-bauhaus-poster — navigation presence", () => {
...
describe("Style 28: 28-bauhaus-poster — navigation behavior", () => {
...
describe("Style 28: 28-bauhaus-poster — overflow check", () => {
...
describe("Style 28: 28-bauhaus-poster — metadata structure", () => {
  it("returns complete metadata", () => {
    const meta = getMetadata("en");
    expect(meta.id).toBe("expedition-screenprint");
