...
import topic from "./expedition-print";
...
describe("expedition-print render coverage", () => {
...
describe("expedition-print thumbnail mode", () => {
...
describe("expedition-print navigation presence", () => {
...
describe("expedition-print navigation behavior", () => {
...
describe("expedition-print overflow check", () => {
...
describe("expedition-print metadata structure", () => {
  it("keeps complete static metadata", () => {
