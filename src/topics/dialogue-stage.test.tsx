...
import topic from "./dialogue-stage";
...
describe("Dialogue Stage — render coverage", () => {
...
describe("Dialogue Stage — thumbnail mode", () => {
...
describe("Dialogue Stage — navigation presence", () => {
...
describe("Dialogue Stage — navigation behavior", () => {
...
describe("Dialogue Stage — overflow check", () => {
...
describe("Dialogue Stage — metadata structure", () => {
  it("keeps Topic identity outside static metadata", () => {
    const meta = topic.metadata.en;
    expect(topic.styleId).toBe("interactive-dialogue-stage");
    expect(topic.title).toEqual({ en: "Dialogue Stage", zh: "对话舞台" });
