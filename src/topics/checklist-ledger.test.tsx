...
import topic from "./checklist-ledger";
...
describe("Checklist Ledger — render coverage", () => {
...
describe("Checklist Ledger — thumbnail mode", () => {
...
describe("Checklist Ledger — navigation presence", () => {
...
describe("Checklist Ledger — navigation behavior", () => {
...
describe("Checklist Ledger — overflow check", () => {
...
describe("Checklist Ledger — metadata structure", () => {
  it("returns complete metadata", () => {
    const meta = topic.metadata.en;
    expect(topic.id).toBe("checklist-ledger");
    expect(topic.styleId).toBe("checklist-ledger");
    expect(topic.title).toEqual({ en: "Checklist", zh: "检查清单" });
