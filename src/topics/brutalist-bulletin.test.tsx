...
import definition from "./brutalist-bulletin";
...
describe("Brutalist Bulletin — render coverage", () => {
...
describe("Brutalist Bulletin — thumbnail mode", () => {
...
describe("Brutalist Bulletin — navigation presence", () => {
...
describe("Brutalist Bulletin — navigation behavior", () => {
...
describe("Brutalist Bulletin — overflow check", () => {
...
describe("Brutalist Bulletin — metadata structure", () => {
  it("returns complete metadata", () => {
    const meta = definition.metadata.en;
    expect(definition.styleId).toBe("neo-brutalist-bulletin");
    expect(definition.title).toEqual({ en: "Brutalist Bulletin", zh: "粗野公告" });
