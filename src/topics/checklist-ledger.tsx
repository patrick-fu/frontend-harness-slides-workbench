...
import styles from "./checklist-ledger.module.css";
  ...
  en: {
    scenes: [
      ...
      },
      {
        ...
        stats: [
          { value: "20", label: "Passed", color: "var(--checklist-ledger-critical)" },
          { value: "2", label: "Partial", color: "var(--checklist-ledger-high)" },
          { value: "1", label: "Failed", color: "var(--checklist-ledger-medium)" },
          { value: "1", label: "N/A", color: "var(--checklist-ledger-low)" },
        ],
        findings: [
          {
            severity: "Pass",
  ...
  zh: {
    scenes: [
      ...
      },
      {
        ...
        countLabel: "24 项标准",
        stats: [
          { value: "20", label: "通过", color: "var(--checklist-ledger-critical)" },
          { value: "2", label: "部分", color: "var(--checklist-ledger-high)" },
          { value: "1", label: "失败", color: "var(--checklist-ledger-medium)" },
          { value: "1", label: "不适用", color: "var(--checklist-ledger-low)" },
        ],
        findings: [
          {
            severity: "通过",
...
function TopicStage({
  ...
  useLayoutEffect(() => {
    const id = "checklist-ledger-fonts";
