...
import CelticKnot29, { getMetadata } from "./29-celtic-knot";
...
describe("Style 29: 29-celtic-knot — render coverage", () => {
...
describe("Style 29: 29-celtic-knot — thumbnail mode", () => {
...
describe("Style 29: 29-celtic-knot — navigation presence", () => {
...
describe("Style 29: 29-celtic-knot — navigation behavior", () => {
...
describe("Style 29: 29-celtic-knot — overflow check", () => {
...
describe("Style 29: 29-celtic-knot — metadata structure", () => {
  it("returns complete metadata", () => {
    const meta = getMetadata("en");
    expect(meta.id).toBe("cassette-era-packaging");
