...
import styles from "./maintainer-issue-brief-ozone-hole.module.css";
...
export function getMetadata(language: Language): StyleMetadata {
  return {
    ...
    band: "text-report",
    name: language === "zh" ? "维护者问题简报" : "Maintainer Issue Brief",
...
export default function OzoneHoleIssueBrief({
  scene,
  beat,
  language,
  isThumbnail,
...
export const ozoneHoleTopic = defineStyleTopic({
  id: "ozone-hole",
  topic: {
    en: "Ozone Hole",
    zh: "臭氧洞",
