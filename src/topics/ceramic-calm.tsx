...
import styles from "./ceramic-calm.module.css";
...
function TopicStage({
  ...
  // Font loading
  useLayoutEffect(() => {
    if (document.getElementById("ceramic-calm-fonts")) return;
    const link = document.createElement("link");
    link.id = "ceramic-calm-fonts";
    link.rel = "stylesheet";
      ...
      <div className={styles.sceneCenter}>
        <svg className={styles.brushStroke} viewBox="0 0 200 60" preserveAspectRatio="xMidYMid meet">
          <path
            ...
            fill="none"
            stroke="var(--ceramic-calm-ink, #f0ece4)"
            strokeWidth="1.5"
            strokeLinecap="round"
            opacity="0.3"
          />
      ...
      <div className={styles.sceneConcept}>
        <div className={styles.kanjiColumn}>
          ...
          <svg className={styles.brushVertical} viewBox="0 0 20 200" preserveAspectRatio="xMidYMid meet">
            <line x1="10" y1="10" x2="10" y2="190" stroke="var(--ceramic-calm-ink, #f0ece4)" strokeWidth="0.5" opacity="0.2" strokeDasharray="4 6" />
          </svg>
        </div>
