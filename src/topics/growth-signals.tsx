...
const GROWTH_SIGNALS_TRANSITION_SCORE = {
  "1->2": "fade",
  "2->3": "wipe",
  "3->4": "scale-fade",
  "4->5": "page-flip",
...
const TRANSITION_MAP: SceneTransitionMap = GROWTH_SIGNALS_TRANSITION_SCORE;
...
function PressedLeafNav({
  ...
  return (
    <nav
      className="growthSignalsV2__nav"
      aria-label="Scene navigation"
      data-topic-navigation="true"
      data-navigation-geometry="edge-scale"
      data-navigation-carrier="growth-signals-pressed-leaf-index"
...
export default defineTopic({
  ...
  transitionScore: GROWTH_SIGNALS_TRANSITION_SCORE,
  evidence: {
    kind: "illustrative",
    boundary: {
