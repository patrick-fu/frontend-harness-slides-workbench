...
import topic from "./ceramic-calm";
...
describe("Ceramic Calm — render coverage", () => {
...
describe("Ceramic Calm — thumbnail mode", () => {
...
describe("Ceramic Calm — navigation presence", () => {
...
describe("Ceramic Calm — navigation behavior", () => {
...
describe("Ceramic Calm — overflow check", () => {
