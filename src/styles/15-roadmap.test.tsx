...
import Roadmap, { getMetadata } from "./15-roadmap";
...
describe("Style 15: Roadmap — render coverage", () => {
...
describe("Style 15: Roadmap — thumbnail mode", () => {
...
describe("Style 15: Roadmap — navigation presence", () => {
...
describe("Style 15: Roadmap — navigation behavior", () => {
...
describe("Style 15: Roadmap — overflow check", () => {
...
describe("Style 15: Roadmap — metadata structure", () => {
  it("returns complete metadata", () => {
    const meta = getMetadata("en");
    expect(meta.id).toBe("studio-mixing-console");
