...
runTopicContract(fieldNotes);

const TopicStage = fieldNotes.Stage;
...
describe("Field notes — render coverage", () => {
...
describe("Field notes — thumbnail mode", () => {
...
describe("Field notes — navigation presence", () => {
...
describe("Field notes — navigation behavior", () => {
...
describe("Field notes — overflow check", () => {
...
describe("Field notes — metadata structure", () => {
  it("returns complete metadata", () => {
    const meta = fieldNotes.metadata.en;
    expect(fieldNotes.styleId).toBe("field-notes-report");
    expect(fieldNotes.title.en.length).toBeGreaterThan(0);
