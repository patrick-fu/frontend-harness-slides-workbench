...
import styles from "./benchmark-matrix-natural-clocks.module.css";
...
export interface NaturalClocksSource extends TopicSource {
...
export function getMetadata(language: Lang): StyleMetadata {
  ...
  return {
    ...
    name: isZh ? "基准矩阵" : "Benchmark Matrix",
...
export default function NaturalClocks({
  scene,
  beat,
  language,
  isThumbnail,
