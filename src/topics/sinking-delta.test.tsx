...
import componentSource from "./sinking-delta.tsx?raw";
import { runTopicContract } from "../testing/topic-contract";

const { Stage: SinkingDelta } = definition;
...
describe("Sinking Delta topic protocol", () => {
  it("exports the planned Topic contract, evidence packet, and exact score", () => {
    expect(definition.id).toBe("sinking-delta");
    ...
    if (definition.evidence.kind === "mixed") {
      expect(definition.evidence.sources).toBe(SINKING_DELTA_SOURCES);
    }
