...
import styles from "./dialogue-stage.module.css";

// ─── Font Injection ────────────────────────────────────────────────────────

function useFonts() {
  useEffect(() => {
    const id = "dialogue-stage-fonts";
      ...
      <div className={styles.scene3}>
        ...
        <div className={styles.chartLegend}>
          <span className={styles.legendItem}>
            <span className={styles.legendDot} style={{ background: "var(--dialogue-stage-warm, #d4a574)" }} />
            {language === "zh" ? "人类判断" : "Human judgment"}
          </span>
          <span className={styles.legendItem}>
            <span className={styles.legendDot} style={{ background: "var(--dialogue-stage-cool, #58a6ff)" }} />
...
export default defineTopic({
  ...
  title: { en: "Dialogue Stage", zh: "对话舞台" },
