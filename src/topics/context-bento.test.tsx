...
import topic from "./context-bento";
...
describe("Context Bento render coverage", () => {
...
describe("Context Bento thumbnail mode", () => {
...
describe("Context Bento navigation presence", () => {
...
describe("Context Bento navigation behavior", () => {
...
describe("Context Bento overflow check", () => {
...
describe("Context Bento metadata structure", () => {
  it("returns complete metadata", () => {
    const meta = topic.metadata.en;
    expect(topic.styleId).toBe("context-bento-box");
    expect(topic.title).toEqual({ en: "Context Bento", zh: "上下文盒" });
