...
import topic from "./decision-record";
...
describe("Decision Record — render coverage", () => {
...
describe("Decision Record — thumbnail mode", () => {
...
describe("Decision Record — navigation presence", () => {
...
describe("Decision Record — navigation behavior", () => {
...
describe("Decision Record — overflow check", () => {
...
describe("Decision Record — metadata structure", () => {
  it("returns complete metadata", () => {
    const meta = topic.metadata.en;
    expect(topic.id).toBe("decision-record");
